...
public class C02_DropdownReusable {
    ...
    //reusable method oluşturalım   BU BIR JAVA METHODUDUR
...
//        Gonderilen dropdown elemention tum optionslari alinir
    ...
    public void selectFromDropdown(){
        selectFromDropdown(driver.findElement(By.xpath("//select[@id='year']")), "1989");
        selectFromDropdown(driver.findElement(By.id("month")),"April");
        selectFromDropdown(driver.findElement(By.id("day")),"14");
