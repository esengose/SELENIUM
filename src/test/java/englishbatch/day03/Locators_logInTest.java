...
public class Locators_logInTest {
    WebDriver driver;
    @Before
    public void setUp(){
...
//      Locating the button and checking
...
//      Default page : https://opensource-demo.orangehrmlive.com/web/index.php/dashboard/index
        ...
        /*
        NOTE: We do not need to use container. We can use method chain in selenium.
        driver.findElement(By.name("username")).sendKeys("Admin");//memory icin bu yazim daha iyidir.
