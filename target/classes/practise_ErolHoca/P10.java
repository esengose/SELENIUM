...
public class P10 extends TestBase {
        ...
        public void test01() {
            ...
            // ikinci emojiye tıklayın
            WebElement iframe = TestBase.driver.findElement(By.xpath("//*[@id='emoojis']"));
            TestBase.driver.switchTo().frame(iframe);
            TestBase.driver.findElement(By.xpath("(//*[@data-upgraded=',MaterialRipple'])[2]")).click();
            // tüm ikinci emoji öğelerini tıklayın
            List<WebElement> emojiler = TestBase.driver.findElements(By.xpath("//*[@id='nature']//img"));
            ...
            List<WebElement> list = TestBase.driver.findElements(By.xpath("//input[@class='mdl-textfield__input']"));
            ...
            //  apply button a basin
            TestBase.driver.findElement(By.xpath("//*[text()='Apply']")).click();
        }
